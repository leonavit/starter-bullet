...
?>
<section id="about" class="bg-white py-16 lg:py-20 <?php echo esc_attr( sb_section_hide_mobile_class( 'about' ) ); ?>"<?php echo sb_section_bg_style( 'about' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
	<div class="mx-auto grid max-w-7xl items-center gap-10 px-4 lg:grid-cols-2 lg:px-8">
		...
		<div class="sb-section order-1 text-center md:text-start lg:order-2" data-skeleton>
			<h2 class="text-3xl font-extrabold text-navy sm:text-4xl"><?php echo esc_html( (string) $d['title'] ); ?></h2>
			<div class="prose prose-slate mx-auto mt-4 max-w-none text-gray-600 md:mx-0">
